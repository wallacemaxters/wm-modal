...
m.append(r);}else{if(j.template){m.append(j.template);}}m=f(m)(l);j.clickout&&m.on("click",function(){n.cancel();});e.find("body").append(m);return n;};
n.close=function(){o.call(n);k.result.resolve();return n;};n.cancel=function(){o.call(n);k.result.reject();return n;};};angular.element(b).bind("keyup",function(k){if(k.which===27){var j=d[d.length-1];
